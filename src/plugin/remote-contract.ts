...
const modelResultSchema = z
  .object({
    ...
    available: z.boolean(),
    unavailableReason: z
      .enum(['credential_missing', 'availability_check_failed', 'model_not_listed'])
      .optional(),
...
function numberSchema(): TypertSchema {
  return z.number();
}
...
export const GOVERNOR_REMOTE_DESCRIPTORS: readonly InvocationDescriptor[] = Object.freeze([
...
export const GOVERNOR_REMOTE_CONTRIBUTION: TypertRemoteContribution = Object.freeze({
