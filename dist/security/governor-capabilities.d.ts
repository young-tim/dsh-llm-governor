...
/** Host 请求上下文中的主体解析器。 */
export type GovernorPrincipalResolver = () => GovernorPrincipal | undefined | Promise<GovernorPrincipal | undefined>;
/** 权限拒绝，供 HTTP/Remote 边界映射为稳定错误。 */
export declare class GovernorAuthorizationError extends Error {
 ...
 */
export declare function requireGovernorCapability(resolver: GovernorPrincipalResolver, capability: GovernorCapability): Promise<GovernorPrincipal>;
/** local 模式的进程所有者主体；仅由 Host 启动配置构造。 */
export declare function localOwnerPrincipal(id: string): GovernorPrincipal;
